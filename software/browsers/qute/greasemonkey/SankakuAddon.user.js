...
// @grant       unsafeWindow
// @downloadURL https://update.sleazyfork.org/scripts/23597/SankakuAddon.user.js
// @updateURL https://update.sleazyfork.org/scripts/23597/SankakuAddon.meta.js
// ==/UserScript==
...
(async function(unsafeWindow) {
 ...
 <g>
  ...
  function adjust_css() {
    ...
    /* shrink size of tag edit buttons */
    add_style('tr input[type="submit"], tr button { min-width: unset; }');

    /* allow enlarging tag edit box */
    add_style('form#edit-form textarea#post_tags { max-width: unset; }');
...
<textarea cols="83" id="SA-post_tags" name="post[tags]" rows="9" spellcheck="false" tabindex="10" autocomplete="off" style="margin-top: 0.5em;" ></textarea>
  ...
  // detect page
  if (pathname === '/' || match_segments('posts', 'similar')) General.page = Page.Index;
